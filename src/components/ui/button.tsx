...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-stone-950 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-primary text-stone-50 shadow hover:bg-primary/90 ',
        destructive: 'bg-red-500 text-stone-50 shadow-sm hover:bg-red-500/90',
        outline:
          'border border-stone-200 text-white rounded-md bg-black shadow-sm hover:bg-black/80 hover:text-white',
        secondary:
